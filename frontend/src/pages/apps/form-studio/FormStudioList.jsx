...
export default function FormStudioList() {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setSnack({ open: true, message: 'Form deleted successfully', severity: 'success' });
  ...
  return (
    <div className="px-4 sm:px-0 flex flex-col gap-4 min-h-0 flex-1">
      ...
      <Dialog open={deleteDialogOpen} onClose={() => setDeleteDialogOpen(false)}>
        ...
        <DialogContent>
          <DialogContentText>
            Are you sure you want to delete the form &quot;{selectedForm?.title}&quot;? This cannot be undone.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
