  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%', maxHeight: '100%', overflow: 'hidden' }}>
      ...
      <PageContent sx={{ overflow: 'hidden', display: 'flex', flexDirection: 'column', p: 1.5 }}>
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                onChange={(e) => {
                  ...
                  setFormDetails((prev) => ({ ...prev, name: v }));
                }}
        ...
        <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', minWidth: 0, overflow: 'hidden', mt: 0 }}>
            ...
            {activeTab === 0 && (
              <Box sx={{ display: 'flex', gap: 1.5, flexGrow: 1, minHeight: 0, overflow: 'hidden', height: '100%' }}>
                ...
                >
                  ...
                  <Box sx={{ flexGrow: 1, overflow: 'auto', pt: 1.5, borderTop: 1, borderColor: 'divider' }}>
                    <Typography variant="caption" sx={{ mb: 1, display: 'block', fontWeight: 600, color: 'text.secondary' }}>
                      Field Types
                    </Typography>
                    <FieldTypePanel
                ...
                <Box sx={{ flexGrow: 1, minWidth: 0, overflow: 'auto', height: '100%' }}>
                  <FormCanvas
                    sections={sections}
                ...
                <Paper sx={{ width: 200, flexShrink: 0, p: 1.5, borderLeft: 1, borderColor: 'divider' }}>
                  <Typography variant="caption" sx={{ mb: 1, display: 'block', fontWeight: 600, color: 'text.secondary' }}>
                    Reference Types
                  </Typography>
                  <FieldTypePanel
