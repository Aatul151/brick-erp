...
export default function AuditLogs() {
  ...
  const columns = [
    ...
    { field: 'userName', headerName: 'User', width: 120, valueGetter: (_, row) => row.userName || 'System' },
    { field: 'userEmail', headerName: 'Email', width: 180, valueGetter: (_, row) => row.userEmail || '-' },
    { field: 'tenantName', headerName: 'Tenant', width: 120, valueGetter: (_, row) => row.tenantName || 'System' },
    {
      field: 'action',
      headerName: 'Action',
      width: 140,
    ...
    { field: 'resourceType', headerName: 'Resource', width: 110, valueGetter: (_, row) => row.resourceType || '-' },
    { field: 'ipAddress', headerName: 'IP Address', width: 120, valueGetter: (_, row) => row.ipAddress || '-' },
  ];
