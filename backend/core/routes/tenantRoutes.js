...
import {
    createTenantSchema,
    updateTenantSchema,
} from "../../utils/zodSchemaValidation.js";
...
router.post(
    "/",
    authenticate,
    requireRole("Site Admin"),
    zodValidator(createTenantSchema),
...
router.put(
    ...
    authenticate,
    requireRole("Site Admin"),
    zodValidator(updateTenantSchema),
...
router.put(
    ...
    authenticate,
    requireRole("Site Admin"),
    tenantController.updateTenantThemeSetting,
);
router.put(
    "/my-theme/mode",
    authenticate,
    tenantController.updateMyTenantThemeMode,
);
router.post(
    "/:id/suspend",
    authenticate,
