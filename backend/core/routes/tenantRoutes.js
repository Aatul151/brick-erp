...
import { createTenantSchema, updateTenantSchema } from '../../utils/validation.js';
...
router.post('/', authenticate, requireRole('Site Admin'), validate(createTenantSchema), tenantController.createTenant);
router.put('/:id', authenticate, requireRole('Site Admin'), validate(updateTenantSchema), tenantController.updateTenant);
