...
const PROTECTED_ROUTES = [
  ...
  { path: '/tenants', component: Tenants, permission: { resource: RESOURCE.TENANTS, action: ACTION.READ }, roles: ['Site Admin'] },
  { path: '/users', component: Users, permission: { resource: RESOURCE.USERS, action: ACTION.READ }, roles: ['Site Admin', 'Client Admin'] },
  { path: '/roles', component: Roles, permission: { resource: RESOURCE.ROLES, action: ACTION.READ }, roles: ['Site Admin'] },
  { path: '/permissions', component: Permissions, permission: { resource: RESOURCE.PERMISSIONS, action: ACTION.READ }, roles: ['Site Admin'] },
  { path: '/modules', component: Modules, permission: { resource: RESOURCE.MODULES, action: ACTION.READ }, roles: ['Site Admin'] },
  { path: '/audit-logs', component: AuditLogs, permission: { resource: RESOURCE.AUDIT_LOGS, action: ACTION.READ }, roles: ['Site Admin', 'Client Admin'] },
  { path: '/settings', component: Settings, permission: { resource: RESOURCE.SETTINGS, action: ACTION.READ }, roles: ['Site Admin', 'Client Admin'] },
  {
      ...
      <Route>
        <Box sx={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <Box sx={{ textAlign: 'center' }}>
            ...
            <Typography component="a" href="/" color="primary" sx={{ fontWeight: 600, '&:hover': { textDecoration: 'underline' } }}>
              Go to Dashboard
            </Typography>
          </Box>
        </Box>
