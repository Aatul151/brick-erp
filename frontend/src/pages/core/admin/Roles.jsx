...
export default function Roles() {
  ...
  const columns = [
    ...
    { field: 'description', headerName: 'Description', width: 200, valueGetter: (_, row) => row.description || '-' },
    {
      field: 'scope',
      headerName: 'Scope',
      width: 100,
        ...
        <ActionColumnCell
          ...
          getActions={(row) => [
            ...
            },
            {
              ...
              onClick: async () => {
                const ok = await confirm('Delete this role? This action cannot be undone.', { confirmText: 'Delete', confirmVariant: 'danger' });
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Select
          ...
          options={[
            ...
            { value: 'tenant', label: 'Tenant (Organization-level)' }
          ]}
          required
        />
