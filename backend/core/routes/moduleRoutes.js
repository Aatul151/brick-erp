...
import { createModuleSchema, updateModuleSchema } from "../../utils/zodSchemaValidation.js";

const router = express.Router();

router.get("/", authenticate, moduleController.getModules);
router.get("/:id", authenticate, moduleController.getModule);
router.post("/", authenticate, requireRole("Site Admin"), zodValidator(createModuleSchema), moduleController.createModule);
router.put("/:id", authenticate, requireRole("Site Admin"), zodValidator(updateModuleSchema), moduleController.updateModule);
