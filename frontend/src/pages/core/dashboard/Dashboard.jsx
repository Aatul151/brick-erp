  ...
  return (
    <Box
      ...
      sx={{
        ...
        boxShadow: (theme) =>
          theme.palette.mode === 'light' ? '0 2px 8px rgba(0,0,0,0.06)' : '0 2px 8px rgba(0,0,0,0.25)',
        transition: 'box-shadow 0.2s',
        '&:hover': to
          ? {
              boxShadow: (theme) =>
                theme.palette.mode === 'light' ? '0 4px 12px rgba(0,0,0,0.1)' : '0 4px 12px rgba(0,0,0,0.35)',
            }
          : {},
      }}
    >
      <Box sx={{ p: 2.5 }}>
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          ...
          <Box sx={{ ml: 2, flex: 1, minWidth: 0 }}>
            <Box component="dt" sx={{ fontSize: '0.875rem', fontWeight: 500, color: 'text.secondary', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              {title}
            </Box>
            <Box component="dd" sx={{ fontSize: '1.875rem', fontWeight: 600, color: 'text.primary', m: 0 }}>
              {value}
            </Box>
          </Box>
        </Box>
